...
class ModalClick extends React.Component {
   ...
   render(){
      ...
      <button className={"cs-zoom"} onClick={() => {if(this.state.zoom < 4){this.setState({zoom: this.state.zoom += .3})}; if(this.state.zoom2 < 4){this.setState({zoom2: this.state.zoom2 += .3})}; console.log(this.state.zoom)}}><AddCircleOutlineIcon></AddCircleOutlineIcon></button>
      <button className={"cs-zoom" } onClick={() => {if(this.state.zoom > 1){this.setState({zoom: this.state.zoom -= .3})}; if(this.state.zoom2 > 1){this.setState({zoom2: this.state.zoom2 -= .3})}; console.log(this.state.zoom)}}><RemoveIcon></RemoveIcon></button>
      <button className={"cs-zoom" } onClick={() => {this.setState({zoom: 1, zoom2: 1, horizon: 0, vertices: 0}); console.log(this.state.zoom)}}><ZoomOutIcon></ZoomOutIcon></button>
